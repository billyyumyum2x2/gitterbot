...
var BotCommands = {
    ...
    hectorsector: function (input, bot) {
        var msg = "dope as hell";
        return msg;
    },
    
    crichID: function (input, bot) {
        var msg = "dope as hell";
        return msg;
    },
    
    beardofedu: function (input, bot) {
        var msg = "dope as hell";
        return msg;
    },
    
    hollenberry: function (input, bot) {
        var msg = "dope as hell";
        return msg;
    },
    
    github: function (input, bot) {
        var msg = "probably the coolest place to work";
        return msg;
    },
